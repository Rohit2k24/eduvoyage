// src/components/student/Groups.jsx
...
const Groups = () => {
  ...
  const styles = {
    ...
    groupsTitle: {
      marginTop: '40px', // Add margin above the "Groups" title
      fontSize: '2.5rem',
      color: '#343a40',
      textAlign: 'center',
      textTransform: 'uppercase',
  ...
  return (
    <div className="student-dashboard">
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.groupsTitle}>Groups</h1>
        {/* Add your content for the Groups page here */}
